---
{"UID":20230327113328,"aliases":"成员变量,成员变量","tags":null,"source":null,"cssclass":null,"created":"2023-03-27 11:33","updated":"2023-03-27 16:16","dg-publish":true,"permalink":"/prefetcher/codes/ds-patch-codes/","dgPassFrontmatter":true,"noteIcon":""}
---
...
## 2. SPT
![Pasted image 20230327114133.png](/img/user/Prefetcher/codes/SPP/attachments/Pasted%20image%2020230327114133.png)
...
我们主要看一下PB满了的话，如果evict到SPT中，主要是`add_to_spt`函数。这个函数应该是代码的重头戏了
...
![Pasted image 20230327160745.png](/img/user/Prefetcher/codes/SPP/attachments/Pasted%20image%2020230327160745.png)
