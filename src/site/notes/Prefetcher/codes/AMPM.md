---
{"UID":20230508111352,"aliases":"1. 成员变量","tags":null,"source":null,"cssclass":null,"created":"2023-05-08 11:13","updated":"2023-05-08 20:18","dg-publish":true,"permalink":"/prefetcher/codes/ampm/","dgPassFrontmatter":true,"noteIcon":""}
---


# 1. 成员变量 
AMPMPrefetcher里面的主要成员变量是一个`AccessMapPatternMatching`

class AccessMapPatternMatching的主要成员变量有
* AccessMap 
...
## b. set entry state 
将当前访问的cache line的状态设置为AM_ACCESS, 更新一些统计信息
...
## c. issue prefetch requests
首先做了一些处理工作，将3个zone的cache line合并到一个vector里面
